...
public class HistorySumDetailData {
     ...
     * @param deleteflag
     */
    public HistorySumDetailData(Object userid, Integer roomid, Integer usageprice, String date, String publicpersonal, String memo, String deleteflag) {
        super();
        this.userid = userid;
        this.roomid = roomid;
